...
class Homefilmes(LoginRequiredMixin, ListView):
    ...
    model = Filme
    # Objects_list --> lista de itens do modelo
...
class Detalhesfilme(LoginRequiredMixin, DetailView):
    ...
    def get(self, request, *args, **kwargs):
        # descobrir qual filme está acessando e contabilizar uma visualização
    ...
    def get_context_data(self, **kwargs):
        ...
        # Filtrar a minha tabela de filmes para cada categoria relacionado
